...
[![GoDoc](https://pkg.go.dev/badge/github.com/krazyTry/solana-go/v2?status.svg)](https://pkg.go.dev/github.com/krazyTry/solana-go/v2@v1.16.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/solana-foundation/solana-go?include_prereleases&label=release-tag)](https://github.com/krazyTry/solana-go/v2/releases)
[![Build Status](https://github.com/krazyTry/solana-go/v2/workflows/tests/badge.svg?branch=main)](https://github.com/krazyTry/solana-go/v2/actions?query=branch%3Amain)
[![Lint Status](https://github.com/krazyTry/solana-go/v2/workflows/lint/badge.svg?branch=main)](https://github.com/krazyTry/solana-go/v2/actions?query=branch%3Amain+workflow%3Alint)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/krazyTry/solana-go/v2/main)](https://www.tickgit.com/browse?repo=github.com/krazyTry/solana-go/v2&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/krazyTry/solana-go/v2)](https://goreportcard.com/report/github.com/krazyTry/solana-go/v2)
...
```bash
$ cd my-project
$ go get github.com/krazyTry/solana-go/v2@v1.16.0
```
...
You can wait for a transaction confirmation using the `github.com/krazyTry/solana-go/v2/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/krazyTry/solana-go/v2/programs/address-lookup-table"
...
import (
  ...
  "github.com/krazyTry/solana-go/v2/rpc"
  "github.com/krazyTry/solana-go/v2/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/krazyTry/solana-go/v2/programs/system"
  "github.com/krazyTry/solana-go/v2/rpc"
  confirm "github.com/krazyTry/solana-go/v2/rpc/sendAndConfirmTransaction"
  "github.com/krazyTry/solana-go/v2/rpc/jsonrpc"
...
[pkg.go.dev](https://pkg.go.dev/github.com/krazyTry/solana-go/v2@v1.16.0/rpc#pkg-examples).
...
[pkg.go.dev](https://pkg.go.dev/github.com/krazyTry/solana-go/v2@v1.16.0/rpc/ws#pkg-examples).
