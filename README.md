...
[![GoDoc](https://pkg.go.dev/badge/github.com/krazyTry/solana-go?status.svg)](https://pkg.go.dev/github.com/krazyTry/solana-go@v1.16.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/krazyTry/solana-go/releases)
[![Build Status](https://github.com/krazyTry/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/krazyTry/solana-go/actions?query=branch%3Amain)
[![Lint Status](https://github.com/krazyTry/solana-go/workflows/lint/badge.svg?branch=main)](https://github.com/krazyTry/solana-go/actions?query=branch%3Amain+workflow%3Alint)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/krazyTry/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/krazyTry/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/krazyTry/solana-go)](https://goreportcard.com/report/github.com/krazyTry/solana-go)
...
```bash
$ cd my-project
$ go get github.com/krazyTry/solana-go@v1.16.0
```
...
You can wait for a transaction confirmation using the `github.com/krazyTry/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/krazyTry/solana-go/programs/address-lookup-table"
...
func decodeSystemTransfer(tx *solana.Transaction) {
  ...
  // OR
  {
    ...
    //
    //     import (
    //         _ "github.com/krazyTry/solana-go/programs/system"
    //         _ "github.com/krazyTry/solana-go/programs/token"
    //         // ...add more as needed
    //     )
    //
...
import (
  ...
  "github.com/krazyTry/solana-go/rpc"
  "github.com/krazyTry/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/krazyTry/solana-go/programs/system"
  "github.com/krazyTry/solana-go/rpc"
  confirm "github.com/krazyTry/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/krazyTry/solana-go/rpc/jsonrpc"
  "github.com/krazyTry/solana-go/rpc/ws"
  "github.com/krazyTry/solana-go/text"
)
...
[pkg.go.dev](https://pkg.go.dev/github.com/krazyTry/solana-go@v1.16.0/rpc#pkg-examples).
...
[pkg.go.dev](https://pkg.go.dev/github.com/krazyTry/solana-go@v1.16.0/rpc/ws#pkg-examples).
